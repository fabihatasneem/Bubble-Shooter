...
void iDraw()
{
    ...
    else
    {
        ...
        for(int i=0; i<=800; i+=7)
        {
            iLine(i,710,i+3,710);           //draw ceiling for scoreboard
        }
...
//
//                    iSetColor(r+30,g+30,b+30);
//                    iFilledCircle(i,j,15);
//
//                    iSetColor(r+60,g+60,b+60);
//                    iFilledCircle(i,j,12);
//
//                    iSetColor(r+100,g+100,b+100);
//                    iFilledCircle(i,j,8);
//
//                    iSetColor(r+130,g+130,b+130);
//                    iFilledCircle(i,j,4);
//                }
            }
        }
        ...
        if(rep_shoot_color==5)              //Special Ball 2 - vanish all bubbles of same color!
        {
